                    ...
                    <div class="container-fluid">
                        <div class="row mb-3">
                            <div class="col-6 d-flex justify-content-between">
                                <a href="../../Infosoft3/CatalogoDeServicio/tasacion.php?servicio=TASACION&value=1&canal=INTERMEDIATE" class="d-none d-sm-inline-block btn btn-primary btn-sm text-white">
                                    <i class="fa-solid fa-file-invoice-dollar fa-lg text-white"></i> INTERMEDIATE
                                </a>
                                <a href="../../Infosoft3/CatalogoDeServicio/tasacion.php?servicio=TASACION&value=1&canal=FACTURACION POSTPAGO DE VOZ - DATOS - SMS" class="d-none d-sm-inline-block btn btn-primary btn-sm text-white">
                                <i class="fa-solid fa-money-check-dollar fa-lg text-white"></i> FACTURACION POSTPAGO DE VOZ - DATOS - SMS
                                </a>
                            </div>
                            <div class="col-6 d-flex justify-content-end">
                                <a href="../../Infosoft3/CatalogoDeServicio/tasacion.php?servicio=TASACION&value=2"class="d-none d-sm-inline-block btn btn-warning btn-sm text-white">
