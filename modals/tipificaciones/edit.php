<!-- Modal -->
<div class="modal fade" id="edit<?= $r['KET_ID']?>" tabindex="-1" aria-labelledby="edit_label" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered small">
    <div class="modal-content">
      <div class="modal-header btn-light">
        <h5 class="modal-title fw-bold titulo-modal" id="edit_label">Modificación de:  
            <span class="h6 text-uppercase">Matriz tipificaciones - <?= $_GET["area"]?></span>
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form method="POST" action="../../../Infosoft3/conexion/tipificaciones/formTipificaciones.php" name="form-editCatalogo">
            <div class="row g-2">
                <div class="mb-2 col-2">
                    <label for="nivel_criticidad" class="titulo-modal ">Tipo de caso</label>
                    <select type="text" id="type_caso" name="type_caso" class="form-select form-select-sm" >
                        <option value="<?=$r['KET_TYPE_CASO'];?>">Elegir...</option>
                ...
                <div class="mb-2 col-10">
                    ...
                    <select type="text" id="resumen" name="resumen" class="form-select form-select-sm" >
                        <option value="<?=$r['KET_RESUMEN'];?>">Elegir...</option>
            ...
            <div class="row g-3">
                <div class="mb-2 col-4">
                    ...
                    <select type="text" id="nivel_op1" name="nivel_op1" class="form-select form-select-sm" >
                        <option value="<?=$r['KET_OPERACIONES1'];?>">Elegir...</option>
                ...
                <div class="mb-2 col-4">
                    ...
                    <select type="text" id="nivel_op2" name="nivel_op2" class="form-select form-select-sm" >
                        <option value="<?=$r['KET_OPERACIONES2'];?>">Elegir...</option>
                ...
                <div class="mb-2 col-4">
                    ...
                    <select type="text" id="nivel_op3" name="nivel_op3" class="form-select form-select-sm" >
                        <option value="<?=$r['KET_OPERACIONES3'];?>">Elegir...</option>
            ...
            <div class="row g-3">
                <div class="mb-2 col-4">
                    <label for="nivel_op1" class="titulo-modal ">Nivel 1</label>
                    <select type="text" id="nivel_p1" name="nivel_p1" class="form-select form-select-sm" >
                        <option value="<?=$r['KET_OPERACIONES1'];?>">Elegir...</option>
                ...
                <div class="mb-2 col-4">
                    <label for="nivel_criticidad" class="titulo-modal ">Nivel 2</label>
                    <select type="text" id="nivel_p2" name="nivel_p2" class="form-select form-select-sm" >
                        <option value="<?=$r['KET_OPERACIONES2'];?>">Elegir...</option>
                ...
                <div class="mb-2 col-4">
                    <label for="nivel_criticidad" class="titulo-modal ">Nivel 3</label>
                    <select type="text" id="nivel_p3" name="nivel_p3" class="form-select form-select-sm" >
                        <option value="<?=$r['KET_OPERACIONES3'];?>">Elegir...</option>
